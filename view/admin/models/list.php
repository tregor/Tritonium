    ...
    <? if (!empty($models)) {?>
      <div class="table-responsive">
        <table class="table">
          <thead>
            <tr>
              <?php foreach (array_keys($models[0]) as $colTitle) { ?>
          ...
          <tbody>
            <?php foreach ($models as $id => $row) { ?>
              <tr>
                  ...
                  ?>
                  <td>
                    <a href="<?=$href_base . $modelID?>/view" class="btn btn-outline-secondary">View</a>
                    <a href="<?=$href_base . $modelID?>/edit" class="btn btn-outline-secondary">Edit</a>
                    <a href="<?=$href_base . $modelID?>/copy" target="_blank" class="btn btn-outline-success">Copy</a>
                    <a href="<?=$href_base . $modelID?>/delete" class="btn btn-outline-danger">Delete</a>
                  </td>
              </tr>
              <? } ?>
          </tbody>
