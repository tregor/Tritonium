    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-4 card">
          ...
          <div class="card-body">
            <a href="<?=$href_base . 'edit'?>" class="btn btn-lg btn-block btn-outline-secondary">Edit</a>
            <a href="<?=$href_base . 'copy'?>" target="blank" class="btn btn-lg btn-block btn-outline-success">Copy</a>
            <a href="<?=$href_base . 'delete'?>" class="btn btn-lg btn-block btn-outline-danger">Delete</a>
          </div>
        </div>
      </div>
    </div>
