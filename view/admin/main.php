            ...
            <div class="row gy-4">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="text-center">
                          <div class="position-relative d-inline-block"><img class="avatar avatar-lg mb-3" src="/src/img/avatar-1.jpg" alt="Richard Nevoreski"><span class="avatar-badge bg-dash-color-1">1st</span></div>
              ...
              <div class="col-lg-4">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="text-center">
                          <div class="position-relative d-inline-block"><img class="avatar avatar-lg mb-3" src="/src/img/avatar-4.jpg" alt="Samuel Watson"><span class="avatar-badge bg-dash-color-2">2nd</span></div>
              ...
              <div class="col-lg-4">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="text-center">
                          <div class="position-relative d-inline-block"><img class="avatar avatar-lg mb-3" src="/src/img/avatar-6.jpg" alt="Sebastian Wood"><span class="avatar-badge bg-dash-color-3">3rd</span></div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="row gy-3 align-items-center">
                          <div class="col-lg-4">
                            <div class="d-flex align-items-center"><strong class="text-sm d-none d-lg-block">4th</strong><img class="avatar ms-3" src="/src/img/avatar-1.jpg" alt="Tomas Hecktor">
                              <div class="ms-3">
              ...
              <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="row gy-3 align-items-center">
                          <div class="col-lg-4">
                            <div class="d-flex align-items-center"><strong class="text-sm d-none d-lg-block">5th</strong><img class="avatar ms-3" src="/src/img/avatar-2.jpg" alt="Alexander Shelby">
                              <div class="ms-3">
              ...
              <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="row gy-3 align-items-center">
                          <div class="col-lg-4">
                            <div class="d-flex align-items-center"><strong class="text-sm d-none d-lg-block">6th</strong><img class="avatar ms-3" src="/src/img/avatar-6.jpg" alt="Arther Kooper">
                              <div class="ms-3">
                ...
                <div class="card">
                  <div class="card-body">
                    <h3 class="h4 mb-3">New messages</h3><a class="d-block d-flex align-items-center text-reset text-decoration-none bg-dash-dark-2 py-2 px-3" href="#"> 
                      <div class="position-relative"><img class="avatar" src="/src/img/avatar-3.jpg" alt=""><span class="availability-status bg-success"></span></div>
                      <div class="ms-3">
                      ...
                      <div class="position-relative"><img class="avatar" src="/src/img/avatar-2.jpg" alt=""><span class="availability-status bg-warning"></span></div>
                      <div class="ms-3">
                        <p class="fw-bold mb-0">Peter Ramsy</p>
                        <p class="text-sm fw-light mb-0">lorem ipsum dolor sit amit</p>
                        <p class="small fw-light mb-0">7:30am</p>
                      </div></a><a class="d-block d-flex align-items-center text-reset text-decoration-none bg-dash-dark-2 py-2 px-3" href="#"> 
                      <div class="position-relative"><img class="avatar" src="/src/img/avatar-1.jpg" alt=""><span class="availability-status bg-danger"></span></div>
                      <div class="ms-3">
                        <p class="fw-bold mb-0">Sam Kaheil</p>
                        <p class="text-sm fw-light mb-0">lorem ipsum dolor sit amit</p>
                        <p class="small fw-light mb-0">06:55pm</p>
                      </div></a><a class="d-block d-flex align-items-center text-reset text-decoration-none bg-dash-dark-2 py-2 px-3" href="#"> 
                      <div class="position-relative"><img class="avatar" src="/src/img/avatar-5.jpg" alt=""><span class="availability-status bg-gray"></span></div>
                      <div class="ms-3">
                        <p class="fw-bold mb-0">Sara Wood</p>
                        <p class="text-sm fw-light mb-0">lorem ipsum dolor sit amit</p>
                        <p class="small fw-light mb-0">10:30pm</p>
                      </div></a><a class="d-block d-flex align-items-center text-reset text-decoration-none bg-dash-dark-2 py-2 px-3" href="#"> 
                      <div class="position-relative"><img class="avatar" src="/src/img/avatar-1.jpg" alt=""><span class="availability-status bg-success"></span></div>
                      <div class="ms-3">
